...
(when-var-exists doseq
  (deftest test-doseq
    ...
    ;; [PHEL005] Error in expanding macro "phel\core\dofor"
    ;; Expanding: (dofor [_ nil] (reset! acc :changed))
    ;; Cause: This verb is not supported in for loop
    ...
    ;; [PHEL005] Error in expanding macro "phel\core\dofor"
    ;; Expanding: (dofor [[k v] {:a 0, :b 1}] (swap! acc assoc k v))
    ;; Cause: This verb is not supported in for loop {:a 0, :b 1}
